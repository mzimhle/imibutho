<?php /* Smarty version 2.6.20, created on 2015-07-19 18:35:52
         compiled from gallery/details.tpl */ ?>
...
<div class="inner"> 
    ...
    <div id="sidetabs">
        <ul> 
			...
			<li><a href="<?php if (isset ( $this->_tpl_vars['galleryData'] )): ?>/gallery/image.php?code=<?php echo $this->_tpl_vars['galleryData']['gallery_code']; ?>
<?php else: ?>#<?php endif; ?>" title="Images">Images</a></li>
        </ul>
    </div><!--tabs-->
	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/gallery/details.php<?php if (isset ( $this->_tpl_vars['galleryData'] )): ?>?code=<?php echo $this->_tpl_vars['galleryData']['gallery_code']; ?>
