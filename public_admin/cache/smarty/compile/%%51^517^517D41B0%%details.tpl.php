<?php /* Smarty version 2.6.20, created on 2015-07-19 23:39:44
         compiled from project/video/details.tpl */ ?>
...
<?php else: ?>Add an Video<?php endif; ?></h2>
    <div id="sidetabs">
        <ul> 
			...
			<li><a href="<?php if (isset ( $this->_tpl_vars['videoData'] )): ?>/project/video/comments.php?code=<?php echo $this->_tpl_vars['videoData']['video_code']; ?>
<?php endif; ?>" title="Comments">Comments</a></li>
        </ul>
    </div><!--tabs-->
	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/project/video/details.php<?php if (isset ( $this->_tpl_vars['videoData'] )): ?>?code=<?php echo $this->_tpl_vars['videoData']['video_code']; ?>
...
" size="120" />
		  ...
		  <tr>
			<td colspan="3">				
				...
				<input type="text" name="project_name" id="project_name" value="<?php echo $this->_tpl_vars['videoData']['project_name']; ?>
" size="120" />
				<input type="hidden" name="project_code" id="project_code" value="<?php echo $this->_tpl_vars['videoData']['project_code']; ?>
" />
				<?php else: ?>
				<span class="success"><?php echo $this->_tpl_vars['videoData']['project_name']; ?>
</span>
				<input type="hidden" name="project_code" id="project_code" value="<?php echo $this->_tpl_vars['videoData']['project_code']; ?>
" />				
				<?php endif; ?>
				<?php if (isset ( $this->_tpl_vars['errorArray']['project_code'] )): ?><br /><span class="error"><?php echo $this->_tpl_vars['errorArray']['project_code']; ?>
</span><?php else: ?><br />Project owner of the video<?php endif; ?>
			</td>			  
		  </tr>		  
          <tr>
			<td>
...
$( document ).ready(function() {
	'; ?>
<?php if (! isset ( $this->_tpl_vars['videoData'] )): ?> <?php echo '
