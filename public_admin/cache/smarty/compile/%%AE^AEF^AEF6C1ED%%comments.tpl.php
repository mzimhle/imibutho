<?php /* Smarty version 2.6.20, created on 2015-07-19 23:40:03
         compiled from project/video/comments.tpl */ ?>
...
smarty_core_smarty_include_php(array('smarty_file' => 'includes/header.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><?php echo $this->_tpl_vars['videoData']['video_name']; ?>
</li>
			<li>Comments</li>
        </ul>
	</div><!--breadcrumb--> 	
	 <div class="inner">
      <h2><?php echo $this->_tpl_vars['videoData']['video_name']; ?>
</h2>
...
<?php endif; ?>" title="Details">Details</a></li>
	...
	<form id="addForm" name="addForm" action="/project/video/comments.php?code=<?php echo $this->_tpl_vars['videoData']['video_code']; ?>
" method="post">
...
?>
						<tr>
							<td><?php echo $this->_tpl_vars['comment']['account_name']; ?>
</td>		
