<?php /* Smarty version 2.6.20, created on 2015-07-19 17:41:59
...
<?php else: ?>Add an Article<?php endif; ?></h2>
    <div id="sidetabs">
        <ul> 
			...
			<li><a href="<?php if (isset ( $this->_tpl_vars['articleData'] )): ?>/article/comments.php?code=<?php echo $this->_tpl_vars['articleData']['article_code']; ?>
<?php endif; ?>" title="Comments">Comments</a></li>
        </ul>
    </div><!--tabs-->
	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/article/details.php<?php if (isset ( $this->_tpl_vars['articleData'] )): ?>?code=<?php echo $this->_tpl_vars['articleData']['article_code']; ?>
