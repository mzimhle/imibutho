<?php /* Smarty version 2.6.20, created on 2015-07-18 20:13:26
         compiled from project/view/subscriber.tpl */ ?>
...
" title="Contacts">Contacts</a></li>
			<li class="active"><a href="" title="Subscribers">Subscribers</a></li>
...
" title="Volunteers">Volunteers</a></li>
	...
	<p class="success">Subscribers are those who only get notifications of articles written by the owner of a project any information that pertains to the project but not its upcoming events.</p>
	<form id="addForm" name="addForm" action="/project/view/subscriber.php?code=<?php echo $this->_tpl_vars['projectData']['project_code']; ?>
" method="post">
	<table width="100%" class="innertable" border="0" cellspacing="0" cellpadding="0">	
	  ...
	  <?php $_from = $this->_tpl_vars['subscriberData']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['foo'] = array('total' => count($_from), 'iteration' => 0);
...
?>
	  <tr>											
		...
		<td><?php echo $this->_tpl_vars['item']['subscriber_name']; ?>
</td>		
