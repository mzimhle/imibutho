<?php /* Smarty version 2.6.20, created on 2015-07-20 22:09:45
         compiled from event/comments.tpl */ ?>
...
smarty_core_smarty_include_php(array('smarty_file' => 'includes/header.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><?php echo $this->_tpl_vars['eventData']['event_name']; ?>
</li>
			<li>Comments</li>
        </ul>
	</div><!--breadcrumb--> 	
    ...
    <div id="sidetabs">
        <ul >             
            <li><a href="<?php if (isset ( $this->_tpl_vars['eventData'] )): ?>/event/comments.php?code=<?php echo $this->_tpl_vars['eventData']['event_code']; ?>
<?php endif; ?>" title="Details">Details</a></li>
			<li class="active"><a href="#" title="Comments">Comments</a></li>
        </ul>
    </div><!--tabs-->	
	<div class="detail_box">
	<p class="success">Below are comments made under the given event.</p>
	<form id="addForm" name="addForm" action="/event/comments.php?code=<?php echo $this->_tpl_vars['eventData']['event_code']; ?>
" method="post">
