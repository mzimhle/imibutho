<?php /* Smarty version 2.6.20, created on 2015-04-23 15:33:35
...
<section class="container">
    ...
    We move from the premise that an innumerable number of people and organisations already engage in youth empowerment, so instead of simply adding to those numbers, rather concentration be on ways in which to maximise resources and optimise processes already in existence through a network approach.</p>
            ...
            <div class="rightbox">
					...
					<p>Thank you, <em style="color: #cd682b; font-weight: bold;"><?php echo $this->_tpl_vars['participantloginData']['participant_name']; ?>
 <?php echo $this->_tpl_vars['participantloginData']['participant_surname']; ?>
</em> for registering with the Imibutho Forum website.</p>
 ...
 <?php echo $this->_tpl_vars['participantloginData']['participant_surname']; ?>
</em> for registering with the Imibutho Forum website using <?php echo $this->_tpl_vars['participantloginData']['participantlogin_type']; ?>
.</p>
					<?php endif; ?>			
