...
{include_php file='includes/header.php'}
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/gallery/details.php?code={$galleryData.gallery_code}" title="">{$galleryData.gallery_name}</a></li>
			<li>Images</li>
        </ul>
	</div><!--breadcrumb--> 	
	 <div class="inner">
    ...
    <div id="sidetabs">
        <ul >             
			<li><a href="/gallery/details.php?code={$galleryData.gallery_code}" title="Details">Details</a></li>
			<li class="active"><a href="#" title="Images">Images</a></li>
        </ul>
    </div><!--tabs-->	
	<div class="detail_box">
	<form id="addForm" name="addForm" action="/gallery/image.php?code={$galleryData.gallery_code}" method="post" enctype="multipart/form-data">
