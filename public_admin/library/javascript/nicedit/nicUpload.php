...
define('NICUPLOAD_PATH', realpath(__DIR__.'/../../../../public_html/').'/media/upload/'); // Set the path (relative or absolute) to
 // the directory to save image files
                                      
define('NICUPLOAD_URI', 'http://www.imibutho.co.za/media/upload');   // Set the URL (relative or absolute) to
