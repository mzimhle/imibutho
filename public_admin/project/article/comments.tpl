...
{include_php file='includes/header.php'}
	<div id="breadcrumb">
        <ul>
			...
			<li>{$articleData.article_name}</li>
			<li>Comments</li>
        </ul>
	</div><!--breadcrumb--> 	
	 <div class="inner">
    ...
    <div id="sidetabs">
        <ul >             
            <li><a href="{if isset($articleData)}/project/article/comments.php?code={$articleData.article_code}{/if}" title="Details">Details</a></li>
			<li class="active"><a href="#" title="Comments">Comments</a></li>
        </ul>
    </div><!--tabs-->	
	<div class="detail_box">
	<p class="success">Below are comments made under the given article.</p>
	<form id="addForm" name="addForm" action="/project/article/comments.php?code={$articleData.article_code}" method="post">
