...
{include_php file='includes/header.php'}
    ...
    <div id="sidetabs">
        <ul >             
            <li><a href="{if isset($videoData)}/project/video/comments.php?code={$videoData.video_code}{/if}" title="Details">Details</a></li>
			<li class="active"><a href="#" title="Comments">Comments</a></li>
        </ul>
    </div><!--tabs-->	
	<div class="detail_box">
	<p class="success">Below are comments made under the given video.</p>
	<form id="addForm" name="addForm" action="/project/video/comments.php?code={$videoData.video_code}" method="post">
