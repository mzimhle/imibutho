...
{include_php file='includes/header.php'}
    ...
    <div id="sidetabs">
        <ul >             
            <li><a href="{if isset($eventData)}/project/event/comments.php?code={$eventData.event_code}{/if}" title="Details">Details</a></li>
			<li class="active"><a href="#" title="Comments">Comments</a></li>
        </ul>
    </div><!--tabs-->	
	<div class="detail_box">
	<p class="success">Below are comments made under the given event.</p>
	<form id="addForm" name="addForm" action="/project/event/comments.php?code={$eventData.event_code}" method="post">
