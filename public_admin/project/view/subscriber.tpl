...
{include_php file='includes/header.php'}
	...
	<form id="addForm" name="addForm" action="/project/view/subscriber.php?code={$projectData.project_code}" method="post">
	<table width="100%" class="innertable" border="0" cellspacing="0" cellpadding="0">	
		<tbody>
		  ...
		  {foreach from=$subscriberData item=item name=foo}
		  <tr>											
