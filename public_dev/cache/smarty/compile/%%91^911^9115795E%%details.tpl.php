<?php /* Smarty version 2.6.20, created on 2015-04-24 00:26:55
...
<?php else: ?>Add a Member<?php endif; ?></li>
	...
	<div class="inner"> 
    <h2><?php if (isset ( $this->_tpl_vars['participantData'] )): ?><?php echo $this->_tpl_vars['participantData']['participant_name']; ?>
 <?php echo $this->_tpl_vars['participantData']['participant_surname']; ?>
...
<?php endif; ?>" title="Login">Login</a></li>
			<li><a href="<?php if (isset ( $this->_tpl_vars['participantData'] )): ?>/participant/view/mail.php?code=<?php echo $this->_tpl_vars['participantData']['participant_code']; ?>
...
</span><?php else: ?><br />Members surname<?php endif; ?>
			</td>	
			<td>
				<h4 class="error">Date of Birth:</h4><br />
				<input type="text" name="participant_dateofbirth" id="participant_dateofbirth" value="<?php echo $this->_tpl_vars['participantData']['participant_dateofbirth']; ?>
" size="30"/>
				<?php if (isset ( $this->_tpl_vars['errorArray']['participant_dateofbirth'] )): ?><br /><span class="error"><?php echo $this->_tpl_vars['errorArray']['participant_dateofbirth']; ?>
</span><?php else: ?><br />Member's date of birth<?php endif; ?>
			</td>			
          </tr>
          <tr>
			<td>
...
" size="30" />
			...
			<td>
				<h4>Telephone:</h4><br />
				<input type="text" name="participant_telephone" id="participant_telephone" value="<?php echo $this->_tpl_vars['participantData']['participant_telephone']; ?>
" size="30" />
				<?php if (isset ( $this->_tpl_vars['errorArray']['participant_telephone'] )): ?><br /><span class="error"><?php echo $this->_tpl_vars['errorArray']['participant_telephone']; ?>
          ...
          <tr>	
			<td>
				...
				<select id="participant_reference" name="participant_reference">
					<option value=""> ---- </option>
					<option value="INITIATIVE" <?php if ($this->_tpl_vars['participantData']['participant_reference'] == 'INITIATIVE'): ?>selected<?php endif; ?>> Social Reformer </option>
					<option value="VOLUNTEER" <?php if ($this->_tpl_vars['participantData']['participant_reference'] == 'VOLUNTEER'): ?>selected<?php endif; ?>> Volunteer </option>
				</select>
				<?php if (isset ( $this->_tpl_vars['errorArray']['participant_telephone'] )): ?><br /><span class="error"><?php echo $this->_tpl_vars['errorArray']['participant_telephone']; ?>
</span><?php endif; ?>
			</td>		  
...
" />
          ...
          <tr>	
			<td colspan="3">
				...
				<textarea rows="2" cols="80" name="participant_description" id="participant_description"><?php echo $this->_tpl_vars['participantData']['participant_description']; ?>
</textarea>
				<?php if (isset ( $this->_tpl_vars['errorArray']['participant_description'] )): ?><br /><span class="error"><?php echo $this->_tpl_vars['errorArray']['participant_description']; ?>
</span><?php endif; ?>
			</td>				
          </tr>		  
          <tr>
			<td valign="top" colspan="3">
				...
				<?php else: ?>
					<?php if ($this->_tpl_vars['participantData']['participant_image_path'] == ''): ?>
						<img src="/images/avatar.jpg" />
					<?php else: ?>
						<img src="http://www.imibutho.co.za<?php echo $this->_tpl_vars['participantData']['participant_image_path']; ?>
tmb_<?php echo $this->_tpl_vars['participantData']['participant_image_name']; ?>
