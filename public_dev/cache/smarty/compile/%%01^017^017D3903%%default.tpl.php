...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'participant/view/default.tpl', 47, false),)), $this); ?>
...
?>
			  <tr>
				...
				<td align="left"><img src="<?php if ($this->_tpl_vars['item']['participant_image_path'] == ''): ?>/images/avatar.jpg<?php else: ?>http://www.imibutho.co.za<?php echo $this->_tpl_vars['item']['participant_image_path']; ?>
...
"><?php echo $this->_tpl_vars['item']['participant_name']; ?>
 <?php echo $this->_tpl_vars['item']['participant_surname']; ?>
				...
				<td align="left"><?php echo $this->_tpl_vars['item']['participant_reference']; ?>
</td>
