        ...
        <div class="space cf">
            <div class="leftbox">
                ...
                <form action="" method="post" id="signupform2" class="regform">
                    <label class="leftlabel">Full Name {if isset($errorArray.initiative_name)}<em class="error"> - {$errorArray.initiative_name}</em>{/if}</label>
                    <input type="text" name="initiative_name" id="initiative_name" class="shadow" />
                    <label class="leftlabel">Email{if isset($errorArray.initiative_email)}<em class="error"> - {$errorArray.initiative_email}</em>{/if}</label>
                    <input type="text" name="initiative_email" id="initiative_email"  class="shadow" />                    
                    <label class="leftlabel">Your area {if isset($errorArray.initiative_areapostcode)}<em class="error"> - {$errorArray.initiative_areapostcode}</em>{/if}</label>
                    ...
                    <label class="leftlabel">Short Description{if isset($errorArray.initiative_description)}<em class="error"> - {$errorArray.initiative_description}</em>{/if}</label>
            ...
            <div class="rightbox">
                ...
                <form action="" method="post" id="signupform" class="regform">
                    <label>Name{if isset($errorArray.participant_name)}<em class="error"> - {$errorArray.participant_name}</em>{/if}</label>
                    <input type="text" name="participant_name" id="participant_name" class="shadow" />                    
                    <label>Email{if isset($errorArray.participant_email)}<em class="error"> - {$errorArray.participant_email}</em>{/if}</label>
                    <input type="text" name="participant_email" id="participant_email"  class="shadow" />                    
                    <label>Your area{if isset($errorArray.areapost_code)}<em class="error"> - {$errorArray.areapost_code}</em>{/if}</label>
