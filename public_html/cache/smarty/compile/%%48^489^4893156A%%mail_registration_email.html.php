<?php /* Smarty version 2.6.20, created on 2015-04-23 23:46:18
         compiled from /home/imibuthoco/public_html/templates/mail_registration_email.html */ ?>
<html>
<head>
                        	...
                        	<tr>
                            	<td valign="top" align="left" style="font-size: 12px; font-family: Helvetica, Verdana, Arial, sans-serif;" bgcolor="#FFFFFF">
                                	<span style="font-family: 'Century Gothic', Helvetica, Verdana, Arial, sans-serif; font-size: 24px; font-weight: bold; color: #2a398e;">
										Good day <?php echo $this->_tpl_vars['mailinglist']['mailinglist_name']; ?>
</span><br />
										...
										<p>
										<a style="text-decoration: none; font-family: Helvetica, Verdana, Arial, sans-serif; font-size: 12px; font-weight: bold; color: #0d1959;" href="http://www.imibutho.co.za/mailers/activate/member/<?php echo $this->_tpl_vars['mailinglist']['mailinglist_hashcode']; ?>
">Click here to confirm your email address</a>
										...
										<p style="font-family: Helvetica, Verdana, Arial, sans-serif; font-size: 12px; font-weight: bold; color: #0d1959;">http://www.imibutho.co.za/mailers/activate/member/<?php echo $this->_tpl_vars['mailinglist']['mailinglist_hashcode']; ?>
</p>
...
. You will simply login to your <?php echo $this->_tpl_vars['mailinglist']['participantlogin_type']; ?>
 account, then you will automatically be logged in on our website when it has launched. We will send you a reminder after the website has been launched.</p>
										<p>
									<?php endif; ?>
									<p><a style="text-decoration: none; font-family: Helvetica, Verdana, Arial, sans-serif; font-size: 12px; font-weight: bold; color: #0d1959;" href="http://imibutho.co.za/mailers/view/<?php echo $this->_tpl_vars['tracking']; ?>
