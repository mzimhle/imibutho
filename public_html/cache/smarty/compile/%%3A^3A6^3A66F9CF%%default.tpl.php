<?php /* Smarty version 2.6.20, created on 2015-07-24 08:22:50
        ...
        <div class="space cf">
            <div class="leftbox">
                ...
                <form action="" method="post" id="signupform2" class="regform" enctype="multipart/form-data">
                    <label class="leftlabel">Full name / Organization <?php if (isset ( $this->_tpl_vars['errorArray']['account_name'] )): ?><em class="error"> - <?php echo $this->_tpl_vars['errorArray']['account_name']; ?>
</em><?php endif; ?></label>
                    <input type="text" name="account_name" id="account_name" class="shadow" />
                    <label class="leftlabel">Email<?php if (isset ( $this->_tpl_vars['errorArray']['account_email'] )): ?><em class="error"> - <?php echo $this->_tpl_vars['errorArray']['account_email']; ?>
</em><?php endif; ?></label>
                    <input type="text" name="account_email" id="account_email"  class="shadow" />                    
                    <label class="leftlabel">Your area<?php if (isset ( $this->_tpl_vars['errorArray']['areapost_code'] )): ?><em class="error"> - <?php echo $this->_tpl_vars['errorArray']['areapost_code']; ?>
</em><?php endif; ?></label>
                    <input type="text" name="areapost_name" id="areapost_name"  class="shadow" />                    
					<input type="hidden" name="areapost_code" id="areapost_code" /> 
                    <label class="leftlabel">Image / Organizational Logo<?php if (isset ( $this->_tpl_vars['errorArray']['profileimage'] )): ?><em class="error"> - <?php echo $this->_tpl_vars['errorArray']['profileimage']; ?>
</em><?php endif; ?></label>
